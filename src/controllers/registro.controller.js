...
import { getHipoTemplate, getHiperTemplate } from '../email/templates.js';

class RegistroController {
  static async datosParaGlucosa(req, res) {
    try {
      // 1. Validar parámetro
      ...
      // --- Función matemática para calcular la edad en JS ---
  ...
  static async registrarAlerta(req, res) {
    ...
    try {
      ...
      // 2️⃣ OBTENER DATOS PARA EL CORREO SEGÚN BASE REAL
      ...
      // 4️⃣ ENVIAR CORREO
      await EmailService.sendEmail(usuarioMedico.correo, template.subject, template.html);
